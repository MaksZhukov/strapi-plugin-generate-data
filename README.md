...
- It supports only `string`, `email`, `richtext`, `integer`, `decimal`, `date`, `media`, `boolean` `enumeration`, `password`, `UID` fields of your content types.
...
- Add support for fields `JSON`, `Relation`
