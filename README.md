...
- It supports only `string`, `email`, `richtext`, `integer`, `decimal`, `date`, `media`, `boolean` `enumeration`, `password`, `UID`, `relation` fields of your content types.
